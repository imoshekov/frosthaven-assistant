...
const UIController = {
  ...
  addCharacter(autoInput) {
    var _monsterData$baseStat, _selectedMonster$move, _selectedMonster$acti, _selectedMonster$acti2;
    const type = (autoInput === null || autoInput === void 0 ? void 0 : autoInput.type) || document.getElementById('type').value.toLowerCase();
    const standee = (autoInput === null || autoInput === void 0 ? void 0 : autoInput.standee) || document.getElementById('standee-number').value;
    const level = parseInt(autoInput === null || autoInput === void 0 ? void 0 : autoInput.level) || parseInt(document.getElementById('level').value);
    const isElite = (autoInput === null || autoInput === void 0 ? void 0 : autoInput.isElite) || document.getElementById('elite-monster').checked;
    ...
    const selectedMonster = isElite ? monsterData.stats.find(x => x.type === 'elite' && x.level === level) : monsterData.stats[level];

    // Generate creature names
    const {
      baseName,
      displayName
    } = this.generateCreatureName({
      isElite,
      type,
      standee
    });
    ...
    const initMovement = ((_monsterData$baseStat = monsterData.baseStat) === null || _monsterData$baseStat === void 0 ? void 0 : _monsterData$baseStat.movement) || selectedMonster.movement;
    const defaultAttack = parseInt(selectedMonster === null || selectedMonster === void 0 ? void 0 : selectedMonster.attack) || 0;
    const defaultMovement = Math.max(initMovement !== null && initMovement !== void 0 ? initMovement : 0, (_selectedMonster$move = selectedMonster === null || selectedMonster === void 0 ? void 0 : selectedMonster.movement) !== null && _selectedMonster$move !== void 0 ? _selectedMonster$move : 0);
    const defaultHP = parseInt(selectedMonster === null || selectedMonster === void 0 ? void 0 : selectedMonster.health) || 0;
    const defaultArmor = (selectedMonster === null || selectedMonster === void 0 || (_selectedMonster$acti = selectedMonster.actions) === null || _selectedMonster$acti === void 0 || (_selectedMonster$acti = _selectedMonster$acti.find(x => x.type === 'shield')) === null || _selectedMonster$acti === void 0 ? void 0 : _selectedMonster$acti.value) || 0;
    const defaultRetaliate = (selectedMonster === null || selectedMonster === void 0 || (_selectedMonster$acti2 = selectedMonster.actions) === null || _selectedMonster$acti2 === void 0 || (_selectedMonster$acti2 = _selectedMonster$acti2.find(x => x.type === 'retaliate')) === null || _selectedMonster$acti2 === void 0 ? void 0 : _selectedMonster$acti2.value) || 0;
...
<div class='creature-column' >
    ...
    <div class='nameplate'>
        ...
        <div class='character-skin'>
            <div class="name">
                ...
                <b>${creature.aggressive ? `<input type="tel" class="standee-only" value="${creature.standee}"
  ...
  updateStat(index, stat, value, massApply = false, isCondition = false, isTemporary = false) {
    ...
    const targets = massApply ? characters.filter(character => character.type === typeToUpdate) : [characters[index]];
  ...
  nextRound() {
    ...
    elements.forEach(e => {
      ...
      const fill = (_e$querySelector = e.querySelector('path')) === null || _e$querySelector === void 0 ? void 0 : _e$querySelector.getAttribute('fill');
      if (!fill) {
        return;
      }
