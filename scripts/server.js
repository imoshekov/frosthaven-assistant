        ...
        case 'characters-update':
          {
            ...
            session.lastActivity = Date.now();
            broadcastToSession(currentSessionId, 'characters-update', {
        ...
        case 'graveyard-update':
          {
            ...
            session.lastActivity = Date.now();
            broadcastToSession(currentSessionId, 'graveyard-update', {
        ...
        case 'round-update':
          {
            ...
            session.lastActivity = Date.now();
            broadcastToSession(currentSessionId, 'round-update', {
        ...
        case 'element-update':
          {
            ...
            session.lastActivity = Date.now();
            broadcastToSession(currentSessionId, 'element-update', {
        ...
        case 'add-monster':
          {
            ...
            session.lastActivity = Date.now();
            broadcastToSession(currentSessionId, 'add-monster', {
        ...
        case 'initiative-reset':
          {
            ...
            session.lastActivity = Date.now();
            broadcastToSession(currentSessionId, 'initiative-reset', {
              value: data.value,
              originatingClientId: originatingClientId
            });
            break;
