...
(self.webpackChunkfrosthaven_assistant_angular = self.webpackChunkfrosthaven_assistant_angular || []).push([[461], {
  935: () => {
    ...
    const j = ee,
      ...
      $ = Pe && ye || globalThis;
    function He(e, r) {
      for (let c = e.length - 1; c >= 0; c--) "function" == typeof e[c] && (e[c] = Ae(e[c], r + "_" + c));
      return e;
    }
    function Ue(e) {
      return !e || !1 !== e.writable && !("function" == typeof e.get && typeof e.set > "u");
    }
    const We = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope,
      Re = !("nw" in $) && typeof $.process < "u" && "[object process]" === $.process.toString(),
      xe = !Re && !We && !(!Pe || !ye.HTMLElement),
      qe = typeof $.process < "u" && "[object process]" === $.process.toString() && !We && !(!Pe || !ye.HTMLElement),
      we = {},
      ...
      Xe = function (e) {
        ...
        const c = this || e.target || $,
          t = c[r];
        let i;
        return xe && c === ye && "error" === e.type ? (i = t && t.call(this, e.message, e.filename, e.lineno, e.colno, e.error), !0 === i && e.preventDefault()) : (i = t && t.apply(this, arguments), "beforeunload" === e.type && $[gt] && "string" == typeof i ? e.returnValue = i : null != i && !i && e.preventDefault()), i;
      };
    function Ye(e, r, c) {
      let t = pe(e, r);
      if (!t && c && pe(c, r) && (t = {
      ...
      const u = t.get,
        ...
        T = r.slice(2);
      let p = we[T];
      p || (p = we[T] = j("ON_PROPERTY" + T)), t.set = function (D) {
        let d = this;
        !d && e === $ && (d = $), d && ("function" == typeof d[p] && d.removeEventListener(T, Xe), E?.call(d, null), d[p] = D, "function" == typeof D && d.addEventListener(T, Xe, !1));
      }, t.get = function () {
        let D = this;
        ...
        if (u) {
          let R = u.call(this);
          if (R) return t.set.call(this, R), "function" == typeof D.removeAttribute && D.removeAttribute(r), R;
        }
        return null;
      }, Oe(e, r, t), e[i] = !0;
    }
    function $e(e, r, c) {
      if (r) for (let t = 0; t < r.length; t++) Ye(e, "on" + r[t], c);else {
        const t = [];
    ...
    function ve(e) {
      ...
      for (t in c) "XMLHttpRequest" === e && "responseBlob" === t || function (i) {
        "function" == typeof c[i] ? $[e].prototype[i] = function () {
          ...
          set: function (u) {
            "function" == typeof u ? (this[re][i] = Ae(u, e + "." + i), fe(this[re][i], u)) : this[re][i] = u;
          },
          get: function () {
            return this[re][i];
          }
    ...
    function ue(e, r, c) {
      ...
      const i = j(r);
      let u = null;
      if (t && (!(u = t[i]) || !t.hasOwnProperty(i)) && (u = t[i] = t[r], Ue(t && pe(t, r)))) {
        const T = c(u, i, r);
        t[r] = function () {
    ...
    function kt(e, r, c) {
      ...
      t = ue(e, r, u => function (E, T) {
        const p = c(E, T);
        return p.cbIdx >= 0 && "function" == typeof T[p.cbIdx] ? je(p.name, T[p.cbIdx], p, i) : u.apply(E, T);
      });
    }
    function fe(e, r) {
    ...
    function yt(e, r, c, t) {
      const i = t && t.add || Ze,
        ...
        M = function (y, h, H) {
          ...
          const V = y.callback;
          let Y;
          "object" == typeof V && V.handleEvent && (y.callback = g => V.handleEvent(g), y.originalDelegate = V);
          try {
            y.invoke(y, h, [H]);
          } catch (g) {
            Y = g;
          ...
          const F = y.options;
          return F && "object" == typeof F && F.once && h[u].call(h, H.type, y.originalDelegate ? y.originalDelegate : y.callback, F), Y;
        };
      function x(y, h, H) {
      ...
      function K(y, h) {
        ...
        const q = H ? function (s) {
            if (!O.isExisting) return w.call(O.target, O.eventName, O.capture ? J : z, O.options);
          } : function (s) {
          ...
          A = H ? function (s) {
            if (!s.isRemoved) {
              ...
              if (C) for (let k = 0; k < C.length; k++) if (C[k] === s) {
                C.splice(k, 1), s.isRemoved = !0, s.removeAbortListener && (s.removeAbortListener(), s.removeAbortListener = null), 0 === C.length && (s.allRemoved = !0, s.target[v] = null);
                break;
              }
            }
            if (s.allRemoved) return b.call(s.target, s.eventName, s.capture ? J : z, s.options);
          } : function (s) {
            return b.call(s.target, s.eventName, s.invoke, s.options);
          },
          he = h?.diff || function (s, l) {
            const v = typeof l;
          ...
          a = function (s, l, v, C, k = !1, Z = !1) {
            return function () {
              ...
              if (Re && "uncaughtException" === I) return s.apply(this, arguments);
              let B = !1;
              ...
              if (de) for (let ce = 0; ce < de.length; ce++) if (I === de[ce]) return Te ? s.call(L, I, G, ie) : s.apply(this, arguments);
              ...
              let De,
                ...
                ut = !1;
              if (ke) {
                if (ut = !0, Y) for (let ce = 0; ce < ke.length; ce++) if (he(ke[ce], G)) return;
              } else ke = L[lt] = [];
              const ft = L.constructor.name,
                ht = et[ft];
              ht && (De = ht[I]), De || (De = ft + l + (U ? U(I) : I)), O.options = ie, at && (O.options.once = !1), O.target = L, O.capture = Ge, O.eventName = I, O.isExisting = ut;
              ...
              if (ge) {
                ...
                s.call(ge, "abort", ce, {
                  once: !0
                }), se.removeAbortListener = () => ge.removeEventListener("abort", ce);
              }
              return O.target = null, be && (be.taskData = null), at && (O.options.once = !0), "boolean" != typeof se.options && (se.options = ie), se.target = L, se.capture = Ge, se.eventName = I, B && (se.originalDelegate = G), Z ? ke.unshift(se) : ke.push(se), k ? L : void 0;
            };
          };
        return g[i] = a(w, D, q, A, F), W && (g[d] = a(W, R, function (s) {
          return W.call(O.target, O.eventName, s.invoke, O.options);
        }, A, F, !0)), g[u] = function () {
          const s = this || e;
          let l = arguments[0];
          ...
          if (I) for (let G = 0; G < I.length; G++) {
            const B = I[G];
            if (he(B, k)) return I.splice(G, 1), B.isRemoved = !0, 0 !== I.length || (B.allRemoved = !0, s[L] = null, C || "string" != typeof l) || (s[me + "ON_PROPERTY" + l] = null), B.zone.cancelTask(B), F ? s : void 0;
          }
          ...
          if (F) return this;
        }, fe(g[i], w), fe(g[u], b), Q && fe(g[T], Q), S && fe(g[E], S), !0;
      }
      let X = [];
    ...
    function Ee(e, r, c, t) {
      ...
      function T(D) {
        ...
        return Qe(R) ? d.handleId = R : (d.handle = R, d.isRefreshable = Ke(R.refresh)), D;
      }
      function p(D) {
        const {
          handle: d,
      ...
      i = ue(e, r += t, D => function (d, R) {
        if (Ke(R[0])) {
          const M = {
              isRefreshable: !1,
              isPeriodic: "Interval" === t,
              delay: "Timeout" === t || "Interval" === t ? R[1] || 0 : void 0,
              args: R
            },
            x = R[0];
          R[0] = function () {
          ...
          if (J) E[J] = z;else if (K && (K[Ce] = z, X && !y)) {
            const h = K.refresh;
            K.refresh = function () {
              const {
                zone: H,
              ...
              return "notScheduled" === V ? (z._state = "scheduled", H._updateTaskCount(z, 1)) : "running" === V && (z._state = "scheduling"), h.call(this);
            };
          }
          return K ?? J ?? z;
        }
        return D.apply(e, R);
      }), u = ue(e, c, D => function (d, R) {
        const M = R[0];
        let x;
        Qe(M) ? (x = E[M], delete E[M]) : (x = M?.[Ce], x ? M[Ce] = null : x = M), x?.type ? x.cancelFn && x.zone.cancelTask(x) : D.apply(e, R);
      });
    }
    function st(e, r, c) {
    ...
    function Nt(e, r, c, t, i) {
      ...
      const E = r[u] = r[t];
      r[t] = function (T, p, D) {
        return p && p.prototype && i.forEach(function (d) {
          const R = `${c}.${t}::` + d,
            M = p.prototype;
          try {
            if (M.hasOwnProperty(d)) {
              const x = e.ObjectGetOwnPropertyDescriptor(M, d);
              x && x.value ? (x.value = e.wrapWithCurrentZone(x.value, R), e._redefineProperty(p.prototype, d, x)) : M[d] && (M[d] = e.wrapWithCurrentZone(M[d], R));
      ...
      return e.Zone ??= function ze() {
          ...
          class N {
            ...
            runTask(n, o, m) {
              ...
              try {
                ...
                const oe = n.state;
                if (oe !== X && oe !== Y) if (q == U || A || _e && oe === y) he && P._transitionTo(h, H, y);else {
            ...
            scheduleTask(n) {
              ...
              try {
                ...
                throw n._transitionTo(Y, y, X), this._zoneDelegate.handleError(this, m), m;
              }
              return n._zoneDelegates === o && this._updateTaskCount(n, 1), n.state == y && n._transitionTo(h, y), n;
            }
        ...
        class u {
          ...
          scheduleTask(_, n) {
            ...
            if (this._scheduleTaskZS) this._hasTaskZS && o._zoneDelegates.push(this._hasTaskDlgtOwner), o = this._scheduleTaskZS.onScheduleTask(this._scheduleTaskDlgt, this._scheduleTaskCurrZone, _, n), o || (o = n);else if (n.scheduleFn) n.scheduleFn(n);else {
              if (n.type != F) throw new Error("Task is missing scheduleFn.");
              z(n);
            }
            return o;
          }
        ...
        class E {
          ...
          constructor(_, n, o, m, P, q) {
            if (this.type = _, this.source = n, this.data = m, this.scheduleFn = P, this.cancelFn = q, !o) throw new Error("callback is not defined");
            this.callback = o;
            const A = this;
            this.invoke = _ === U && m && m.useG ? E.invokeTask : function () {
    ...
    (function Lt(e) {
        ...
        e.__load_patch("ZoneAwarePromise", (r, c, t) => {
          ...
          function N(f, a, s) {
            ...
            if (f[y] === g) {
              ...
              if (a !== O && s instanceof A && s.hasOwnProperty(y) && s.hasOwnProperty(h) && s[y] !== g) n(s), N(f, s[y], s[h]);else if (a !== O && "function" == typeof v) try {
                ...
                f[y] = a;
                const C = f[h];
                if (f[h] = s, f[H] === H && a === U && (f[y] = f[Y], f[h] = f[V]), a === O && s instanceof Error) {
                  const k = c.currentTask && c.currentTask.data && c.currentTask.data.__creationTrace__;
                  k && u(s, W, {
                    configurable: !0,
                    enumerable: !1,
                    writable: !0,
                ...
                for (let k = 0; k < C.length;) o(f, C[k++], C[k++], C[k++], C[k++]);
                if (0 == C.length && a == O) {
                  f[y] = 0;
                  let k = s;
                  try {
                  ...
                  D && (k.throwOriginal = !0), k.rejection = s, k.promise = f, k.zone = c.current, k.task = c.currentTask, p.push(k), t.scheduleMicroTask();
                }
              }
            }
            return f;
          ...
          function o(f, a, s, l, v) {
            n(f);
            const C = f[y],
              k = C ? "function" == typeof l ? l : K : "function" == typeof v ? v : X;
            a.scheduleMicroTask("Promise.then", () => {
              try {
                const Z = f[h],
                  L = !!s && H === s[H];
                L && (s[V] = Z, s[Y] = C);
                const I = a.run(k, void 0, L && k !== X && k !== K ? [] : [Z]);
                N(s, !0, I);
              } catch (Z) {
                N(s, !1, Z);
              }
          ...
          class A {
            ...
            static any(a) {
              ...
              return new A((k, Z) => {
                for (let L = 0; L < s.length; L++) s[L].then(I => {
                  ...
                  C.push(I), l--, 0 === l && (v = !0, Z(new q(C, "All promises were rejected")));
                });
              });
            }
            static race(a) {
            ...
            static allWithCallback(a, s) {
              ...
              for (let I of a) {
                ...
                try {
                  I.then(B => {
                    L[G] = s ? s.thenCallback(B) : B, k--, 0 === k && l(L);
                  }, B => {
                    s ? (L[G] = s.errorCallback(B), k--, 0 === k && l(L)) : v(B);
                  });
                } catch (B) {
                  v(B);
                }
            ...
            then(a, s) {
              ...
              const v = new l(P),
                C = c.current;
              return this[y] == g ? this[h].push(C, v, a, s) : o(this, C, v, a, s), v;
            }
            catch(a) {
              ...
              l[H] = H;
              const v = c.current;
              return this[y] == g ? this[h].push(v, l, a, a) : o(this, v, l, a, a), l;
            }
          }
          ...
          function de(f) {
            ...
            const l = a.then;
            a[R] = l, f.prototype.then = function (v, C) {
              return new A((Z, L) => {
                l.call(this, Z, L);
              }).then(v, C);
            }, f[he] = !0;
          ...
          }(f))), Promise[c.__symbol__("uncaughtPromiseErrors")] = p, A;
        });
      })(e), function Ot(e) {
      ...
      e.__load_patch("legacy", r => {
        ...
        const c = "set",
          t = "clear";
        Ee(r, c, t, "Timeout"), Ee(r, c, t, "Interval"), Ee(r, c, t, "Immediate");
      }), e.__load_patch("requestAnimationFrame", r => {
        Ee(r, "request", "cancel", "AnimationFrame"), Ee(r, "mozRequest", "mozCancel", "AnimationFrame"), Ee(r, "webkitRequest", "webkitCancel", "AnimationFrame");
      }), e.__load_patch("blocking", (r, c) => {
        const t = ["alert", "prompt", "confirm"];
        for (let i = 0; i < t.length; i++) ue(r, t[i], (E, T, p) => function (D, d) {
        ...
        !function D(d) {
          ...
          function y(w) {
            ...
            const W = S[u] = () => {
              if (S.readyState === S.DONE) if (!b.aborted && S[E] && w.state === X) {
                const _ = S[c.__symbol__("loadfalse")];
                if (0 !== S.status && _ && _.length > 0) {
                  const n = w.invoke;
                  w.invoke = function () {
                    const o = S[c.__symbol__("loadfalse")];
                    for (let m = 0; m < o.length; m++) o[m] === w && o.splice(m, 1);
                    !b.aborted && w.state === X && n.call(w);
                  }, _.push(w);
                } else w.invoke();
              } else !b.aborted && !1 === S[E] && (S[p] = !0);
            };
            return z.call(S, K, W), S[t] || (S[t] = w), U.apply(S, b.args), S[E] = !0, w;
          }
          function h() {}
          function H(w) {
            const b = w.data;
          ...
          const V = ue(M, "open", () => function (w, b) {
            ...
            U = ue(M, "send", () => function (w, b) {
              if (!0 === c.current[g] || w[i]) return U.apply(w, b);
              {
                ...
                w && !0 === w[p] && !S.aborted && Q.state === X && Q.invoke();
              }
            }),
            O = ue(M, "abort", () => function (w, b) {
        ...
        r.navigator && r.navigator.geolocation && function Et(e, r) {
